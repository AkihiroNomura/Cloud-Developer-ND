...
const jwksUrl = 'https://dev-46rwnrr1.us.auth0.com/.well-known/jwks.json'
...
const getCert = async (url: string): Promise<string> => {
  let cert: string
  try {
...
// const getCert = async (jwksUrl: string, jwt: Jwt): Promise<string> => {
